package com.spring3.firstproject.model;
...
public class User implements UserDetails { // UserDetails é obrigatório para o Spring Security
    ...
    // precisa ser unique porque trata-se do login de usuário
    ...
    // EAGER significa que assim que acrregar o user, carrega juntamente as permissões
    @ManyToMany(fetch = FetchType.EAGER)
    @JoinTable( // define qual tabela é responsável por representar o relacionamento e os nomes nessa tabela
