...
public class PersonController {
    ...
    */
    ...
    // ResponseEntity<Page<PersonVO>> para adicionar paginação, mas ResponseEntity<PagedModel<EntityModel<PersonVO>>> para adicionar Hateoas
    public ResponseEntity<PagedModel<EntityModel<PersonVO>>> findAll( // separando resposta por páginas, para melhorar desempenho
    ...
    @Operation(
        summary = "Finds people that matches the sent name", description = "Finds people that matches the sent name", tags = {"People"},
        responses = {
            @ApiResponse(description = "Success", responseCode = "200", content = {
                @Content(
                    mediaType = "application/json",
